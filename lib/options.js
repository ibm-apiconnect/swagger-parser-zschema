...
ParserOptions.defaults = {
  ...
  dereference: {
    /**
     * Don't throw errors for circular references
     */
    circular: "ignore",
    
    /**
     * Continue dereferencing even if some refs can't be resolved
     */
    onDereference: undefined,
  },
  
  /**
   *  Configure resolve options to be more permissive
   */
  resolve: {
    /**
     * Allow external references (http, file, etc.)
     */
    external: true,
  },
};
